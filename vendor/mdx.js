...
var require_xhtml = __commonJS({
  "node_modules/micromark-extension-mdxjs/node_modules/acorn-jsx/xhtml.js"(exports, module2) {
    module2.exports = {
      quot: '"',
      amp: "&",
      apos: "'",
...
var require_acorn = __commonJS({
  "node_modules/micromark-extension-mdxjs/node_modules/acorn/dist/acorn.js"(exports, module2) {
    (function(global, factory2) {
      ...
      types$12.star.updateContext = function(prevType) {
        if (prevType === types$12._function) {
          var index5 = this.context.length - 1;
          if (this.context[index5] === types2.f_expr) {
            this.context[index5] = types2.f_expr_gen;
          } else {
            this.context[index5] = types2.f_gen;
          }
        }
        this.exprAllowed = true;
      };
...
var require_acorn_jsx = __commonJS({
  "node_modules/micromark-extension-mdxjs/node_modules/acorn-jsx/index.js"(exports, module2) {
    "use strict";
...
types$1.star.updateContext = function(prevType) {
  if (prevType === types$1._function) {
    var index5 = this.context.length - 1;
    if (this.context[index5] === types.f_expr) {
      this.context[index5] = types.f_expr_gen;
    } else {
      this.context[index5] = types.f_gen;
    }
  }
  this.exprAllowed = true;
};
...
function combineExtensions(extensions) {
  ...
  while (++index5 < extensions.length) {
    syntaxExtension(all4, extensions[index5]);
  }
  return all4;
}
...
function visit(tree, visitor) {
  ...
  function build(node, key, index5, parents) {
    if (nodelike(node)) {
      visit4.displayName = "node (" + color(node.type) + ")";
    }
    return visit4;
    function visit4() {
      var result = enter ? toResult(enter(node, key, index5, parents)) : [];
      var cKey;
      var cIndex;
      var grandparents;
      var subresult;
      ...
      return leave ? toResult(leave(node, key, index5, parents)) : result;
    }
  }
}
...
function location(file) {
  ...
  function toPoint(offset2) {
    ...
    if (offset2 > -1 && offset2 < indices[indices.length - 1]) {
      while (++index5 < indices.length) {
        if (indices[index5] > offset2) {
          return {
            line: index5 + 1,
            column: offset2 - (indices[index5 - 1] || 0) + 1,
            offset: offset2
          };
        }
      }
  ...
  function toOffset(point7) {
    var line = point7 && point7.line;
    var column = point7 && point7.column;
    var offset2;
...
function eventsToAcorn(events, options) {
  ...
  while (++index5 < events.length) {
    const [kind, token, context] = events[index5];
    if (kind === "exit") {
  ...
  try {
    ...
    const error = error_;
    const point7 = parseOffsetToUnistPoint(error.pos);
    error.message = String(error.message).replace(/ \(\d+:\d+\)$/, "");
    error.pos = point7.offset;
    error.loc = {
      line: point7.line,
      column: point7.column - 1
    };
    exception = error;
  ...
  if (estree && options.expression && !isEmptyExpression) {
    if (empty2(value.slice(estree.end, value.length - suffix.length))) {
      ...
      const point7 = parseOffsetToUnistPoint(estree.end);
      exception = new Error("Unexpected content after expression");
      exception.pos = point7.offset;
      exception.loc = {
        line: point7.line,
        column: point7.column - 1
      };
  ...
  function fixPosition(nodeOrToken) {
    const pointStart3 = parseOffsetToUnistPoint(nodeOrToken.start);
    const pointEnd3 = parseOffsetToUnistPoint(nodeOrToken.end);
    nodeOrToken.start = pointStart3.offset;
    nodeOrToken.end = pointEnd3.offset;
    nodeOrToken.loc = {
      start: {
        line: pointStart3.line,
        column: pointStart3.column - 1,
        offset: pointStart3.offset
      },
      end: {
        line: pointEnd3.line,
        column: pointEnd3.column - 1,
        offset: pointEnd3.offset
      }
    };
  ...
  function setPoint(point7) {
    if (!startLine || point7.line < startLine) {
      startLine = point7.line;
    }
    if (!(point7.line in lines) || lines[point7.line].offset > point7.offset) {
      lines[point7.line] = point7;
    }
  }
}
...
function name(name2) {
  var index5 = -1;
  while (++index5 < name2.length) {
    if (!(index5 ? cont2 : start2)(name2.charCodeAt(index5)))
      return false;
  }
  return index5 > 0;
}
    ...
    if (events[index5][0] === "enter" && events[index5][1].type === "attentionSequence" && events[index5][1]._close) {
      ...
      while (open--) {
        if (events[open][0] === "exit" && events[open][1].type === "attentionSequence" && events[open][1]._open && context.sliceSerialize(events[open][1]).charCodeAt(0) === context.sliceSerialize(events[index5][1]).charCodeAt(0)) {
          ...
          const end = Object.assign({}, events[index5][1].start);
          ...
          nextEvents = push(nextEvents, resolveAll(context.parser.constructs.insideSpan.null, events.slice(open + 1, index5), context));
          nextEvents = push(nextEvents, [
            ["exit", text5, context],
...
function movePoint(point7, offset2) {
  point7.column += offset2;
  point7.offset += offset2;
  point7._bufferIndex += offset2;
}
...
function subcontent(events, eventIndex) {
  ...
  while (index5--) {
    const slice2 = childEvents.slice(breaks[index5], breaks[index5 + 1]);
...
function tokenizeHtmlFlow(effects, ok2, nok) {
  ...
  function cdataOpenInside(code2) {
    if (code2 === buffer2.charCodeAt(index5++)) {
      effects.consume(code2);
      return index5 === buffer2.length ? self2.interrupt ? ok2 : continuation : cdataOpenInside;
    }
    return nok(code2);
  }
...
function tokenizeHtmlText(effects, ok2, nok) {
  ...
  function cdataOpen(code2) {
    if (code2 === buffer2.charCodeAt(index5++)) {
      effects.consume(code2);
      return index5 === buffer2.length ? cdata : cdataOpen;
    }
    return nok(code2);
  }
...
function tokenizeSetextUnderline(effects, ok2, nok) {
  ...
  while (index5--) {
    if (self2.events[index5][1].type !== "lineEnding" && self2.events[index5][1].type !== "linePrefix" && self2.events[index5][1].type !== "content") {
      paragraph2 = self2.events[index5][1].type === "paragraph";
      break;
    }
  }
  return start3;
...
function mdxjsEsm(options) {
  ...
  function tokenizeExportImport(effects, ok2, nok) {
    ...
    function keyword(code2) {
      if (code2 === buffer2.charCodeAt(index5++)) {
        effects.consume(code2);
        return index5 === buffer2.length ? after : keyword;
      }
      return nok(code2);
    }
    function after(code2) {
      ...
      while (++index6 < result.estree.body.length) {
        ...
        if (node.type === "ImportDeclaration" && !self2.interrupt) {
          ...
          while (++index7 < node.specifiers.length) {
            definedModuleSpecifiers.push(node.specifiers[index7].local.name);
          }
        }
      }
...
// node_modules/mdast-util-mdx-jsx/node_modules/character-entities-legacy/index.js
...
function parseEntities(value, options = {}) {
  ...
  if (options.position) {
    if ("start" in options.position || "indent" in options.position) {
      ...
      point7 = options.position.start;
    } else {
      point7 = options.position;
    }
  }
  let line = (point7 ? point7.line : 0) || 1;
  let column = (point7 ? point7.column : 0) || 1;
  let previous2 = now();
  let character;
  index5--;
  while (++index5 <= value.length) {
    ...
    character = value.charCodeAt(index5);
    if (character === 38) {
      const following = value.charCodeAt(index5 + 1);
      if (following === 9 || following === 10 || following === 12 || following === 32 || following === 38 || following === 60 || Number.isNaN(following) || additional && following === additional) {
        queue += fromCharCode(character);
        column++;
        continue;
      }
      const start3 = index5 + 1;
      let begin = start3;
      let end = start3;
      let type;
      if (following === 35) {
  ...
  function now() {
    return {
      line,
      column,
      offset: index5 + ((point7 ? point7.offset : 0) || 0)
    };
  }
  function warning(code2, offset2) {
    ...
    if (options.warning) {
      ...
      options.warning.call(options.warningContext, messages[code2], position6, code2);
    }
  }
  function flush() {
    if (queue) {
...
// node_modules/mdast-util-mdx-jsx/node_modules/unist-util-stringify-position/index.js
var own5 = {}.hasOwnProperty;
function stringifyPosition2(value) {
  if (!value || typeof value !== "object") {
    return "";
  }
  if (own5.call(value, "position") || own5.call(value, "type")) {
    return position2(value.position);
  }
  if (own5.call(value, "start") || own5.call(value, "end")) {
    return position2(value);
  }
  if (own5.call(value, "line") || own5.call(value, "column")) {
    return point2(value);
  }
  return "";
}
function point2(point7) {
  return index2(point7 && point7.line) + ":" + index2(point7 && point7.column);
}
...
function core(value, options) {
  ...
  function surrogate(pair, index5, all4) {
    return options.format((pair.charCodeAt(0) - 55296) * 1024 + pair.charCodeAt(1) - 56320 + 65536, all4.charCodeAt(index5 + 2), options);
  }
  function basic(character, index5, all4) {
    return options.format(character.charCodeAt(0), all4.charCodeAt(index5 + 1), options);
  }
}
function charactersToExpression(subset) {
  const groups = [];
  let index5 = -1;
  while (++index5 < subset.length) {
    groups.push(subset[index5].replace(/[|\\{}()[\]^$+*?.]/g, "\\$&"));
  }
...
// node_modules/mdast-util-mdx-jsx/node_modules/mdast-util-to-markdown/lib/util/track.js
...
// node_modules/mdast-util-mdx-jsx/node_modules/mdast-util-to-markdown/lib/util/container-flow.js
function containerFlow(parent, context, safeOptions) {
  ...
  while (++index5 < children.length) {
    ...
    if (index5 < children.length - 1) {
      results.push(tracker.move(between(child, children[index5 + 1])));
    }
  }
  indexStack.pop();
  return results.join("");
  function between(left, right) {
    let index6 = context.join.length;
    while (index6--) {
      const result = context.join[index6](left, right, parent, context);
...
// node_modules/mdast-util-mdx-jsx/node_modules/mdast-util-to-markdown/lib/util/container-phrasing.js
function containerPhrasing(parent, context, safeOptions) {
  ...
  while (++index5 < children.length) {
    ...
    if (index5 + 1 < children.length) {
      let handle = context.handle.handlers[children[index5 + 1].type];
      if (handle && handle.peek)
        handle = handle.peek;
      after = handle ? handle(children[index5 + 1], parent, context, {
        before: "",
        after: "",
        ...tracker.current()
      }).charAt(0) : "";
...
// node_modules/mdast-util-mdx-jsx/node_modules/mdast-util-to-markdown/lib/util/indent-lines.js
var eol = /\r?\n|\r/g;
...
function mdxJsxFromMarkdown() {
  ...
  function exitMdxJsxTag(token) {
    ...
    if (tag.close && tail.name !== tag.name) {
      throw new VFileMessage("Unexpected closing tag `" + serializeAbbreviatedTag(tag) + "`, expected corresponding closing tag for `" + serializeAbbreviatedTag(tail) + "` (" + stringifyPosition2(tail) + ")", { start: token.start, end: token.end }, "mdast-util-mdx-jsx:end-tag-mismatch");
    }
    this.resume();
    if (tag.close) {
      stack.pop();
  ...
  function onErrorRightIsTag(closing, open) {
    ...
    throw new VFileMessage("Expected a closing tag for `" + serializeAbbreviatedTag(tag) + "` (" + stringifyPosition2({ start: open.start, end: open.end }) + ")" + place, position6, "mdast-util-mdx-jsx:end-tag-mismatch");
  }
  function onErrorLeftIsTag(a, b) {
    const tag = this.getData("mdxJsxTag");
    throw new VFileMessage("Expected the closing tag `" + serializeAbbreviatedTag(tag) + "` either after the end of `" + b.type + "` (" + stringifyPosition2(b.end) + ") or another opening tag after the start of `" + b.type + "` (" + stringifyPosition2(b.start) + ")", { start: a.start, end: a.end }, "mdast-util-mdx-jsx:end-tag-mismatch");
  }
...
function mdxJsxToMarkdown(options = {}) {
  ...
  function mdxElement(node, _, context, safeOptions) {
    ...
    if (node.attributes && node.attributes.length > 0) {
      ...
      while (++index5 < node.attributes.length) {
        const attribute = node.attributes[index5];
        let result;
...
// node_modules/@mdx-js/mdx/node_modules/remark-mdx/index.js
...
function all(values, includeImageAlt) {
  ...
  var index5 = -1;
  while (++index5 < values.length) {
    result[index5] = one(values[index5], includeImageAlt);
  }
  return result.join("");
}

// node_modules/mdast-util-from-markdown/node_modules/micromark/lib/initialize/content.js
var content2 = {
...
// node_modules/mdast-util-from-markdown/node_modules/micromark/lib/initialize/document.js
var document = {
  ...
  function documentContinue(code2) {
    ...
    if (self2.containerState._closeFlow) {
      ...
      while (index5 < self2.events.length) {
        self2.events[index5][1].end = Object.assign({}, point7);
        index5++;
      }
...
// node_modules/mdast-util-from-markdown/node_modules/micromark/lib/initialize/flow.js
var flow = {
...
// node_modules/mdast-util-from-markdown/node_modules/micromark/lib/initialize/text.js
var resolver = {
      ...
      if (size) {
        const token = {
          ...
          start: {
            ...
            _index: data2.start._index + index5,
            _bufferIndex: index5 ? bufferIndex : data2.start._bufferIndex + bufferIndex
          },
...
// node_modules/mdast-util-from-markdown/node_modules/micromark/lib/create-tokenizer.js
function createTokenizer(parser, initialize, from) {
  let point7 = Object.assign(from ? Object.assign({}, from) : {
    line: 1,
    column: 1,
    offset: 0
  }, {
  ...
  function consume(code2) {
    ...
    if (point7._bufferIndex < 0) {
      ...
      point7._bufferIndex++;
      if (point7._bufferIndex === chunks[point7._index].length) {
...
// node_modules/mdast-util-from-markdown/node_modules/micromark/lib/constructs.js
...
// node_modules/mdast-util-from-markdown/node_modules/micromark/lib/parse.js
...
// node_modules/mdast-util-from-markdown/node_modules/micromark/lib/preprocess.js
var search = /[\0\t\n\r]/g;
function preprocess() {
  let column = 1;
  let buffer2 = "";
...
// node_modules/mdast-util-from-markdown/node_modules/micromark/lib/postprocess.js
...
function point3(point7) {
  return index3(point7 && point7.line) + ":" + index3(point7 && point7.column);
}
...
function compiler(options = {}) {
  ...
  function compile2(events) {
    ...
    while (++index5 < events.length) {
      ...
      if (own7.call(handler, events[index5][1].type)) {
        handler[events[index5][1].type].call(Object.assign({
          sliceSerialize: events[index5][2].sliceSerialize
        }, context), events[index5][1]);
      }
    }
    ...
    tree.position = {
      start: point7(events.length > 0 ? events[0][1].start : {
        line: 1,
        column: 1,
        offset: 0
      }),
      end: point7(events.length > 0 ? events[events.length - 2][1].end : {
        line: 1,
        column: 1,
        offset: 0
      })
    ...
    while (++index5 <= length) {
      ...
      if (!containerBalance && event[0] === "enter" && event[1].type === "listItemPrefix" || containerBalance === -1 && event[0] === "exit" && (event[1].type === "listUnordered" || event[1].type === "listOrdered")) {
        if (listItem3) {
          ...
          events.splice(lineIndex || index5, 0, ["exit", listItem3, event[2]]);
          index5++;
          length++;
        }
        if (event[1].type === "listItemPrefix") {
          ...
          events.splice(index5, 0, ["enter", listItem3, event[2]]);
          index5++;
          length++;
  ...
  function exit2(token, onExitError) {
    ...
    node.position.end = point7(token.end);
    return node;
  }
  function resume() {
  ...
  function onexitdata(token) {
    ...
    tail.position.end = point7(token.end);
  }
...
function unknown(h, node) {
  ...
  if ("value" in node && !(own8.call(data2, "hName") || own8.call(data2, "hProperties") || own8.call(data2, "hChildren"))) {
...
function all2(h, parent) {
  ...
  if ("children" in parent) {
    ...
    while (++index5 < nodes.length) {
      const result = one2(h, nodes[index5], parent);
      if (result) {
...
var visitParents = function(tree, test, visitor, reverse) {
  ...
  factory2(tree, null, [])();
  function factory2(node, index5, parents) {
    ...
    function visit4() {
      ...
      let offset2;
      let grandparents;
      if (!test || is(node, index5, parents[parents.length - 1] || null)) {
...
// node_modules/@mdx-js/mdx/node_modules/unist-util-position/index.js
var pointStart = point4("start");
var pointEnd = point4("end");
function point4(type) {
  return point7;
  function point7(node) {
    const point8 = node && node.position && node.position[type] || {};
    return {
      line: point8.line || null,
      column: point8.column || null,
      offset: point8.offset > -1 ? point8.offset : null
    };
  }
}
...
// node_modules/@mdx-js/mdx/node_modules/mdast-util-definitions/node_modules/unist-util-visit-parents/color.js
function color3(d) {
  return "\x1B[33m" + d + "\x1B[39m";
}

// node_modules/@mdx-js/mdx/node_modules/mdast-util-definitions/node_modules/unist-util-visit-parents/index.js
var CONTINUE3 = true;
var SKIP3 = "skip";
var EXIT3 = false;
...
// node_modules/@mdx-js/mdx/node_modules/mdast-util-definitions/node_modules/unist-util-visit/index.js
...
function normalizeUri(value) {
  ...
  let skip = 0;
  while (++index5 < value.length) {
    const code2 = value.charCodeAt(index5);
    let replace = "";
    if (code2 === 37 && asciiAlphanumeric(value.charCodeAt(index5 + 1)) && asciiAlphanumeric(value.charCodeAt(index5 + 2))) {
      skip = 2;
    } else if (code2 < 128) {
    ...
    if (replace) {
      result.push(value.slice(start3, index5), encodeURIComponent(replace));
      start3 = index5 + skip + 1;
      replace = "";
    }
    if (skip) {
      index5 += skip;
...
function footer(h) {
  let index5 = -1;
  const listItems = [];
  while (++index5 < h.footnoteOrder.length) {
    const def = h.footnoteById[h.footnoteOrder[index5].toUpperCase()];
    if (!def) {
      continue;
    }
...
function footnoteReference(h, node) {
  ...
  const safeId = sanitizeUri(id.toLowerCase());
  const index5 = h.footnoteOrder.indexOf(id);
  let counter;
  if (index5 === -1) {
...
function listItem(h, node, parent) {
  ...
  let index5 = -1;
  while (++index5 < result.length) {
    const child = result[index5];
...
function table(h, node) {
  ...
  const result = [];
  while (++index5 < rows.length) {
    const row = rows[index5].children;
    const name2 = index5 === 0 ? "th" : "td";
    const out = [];
    let cellIndex = -1;
    ...
    result[index5] = h(rows[index5], "tr", wrap2(out, true));
  }
...
var WalkerBase = class {
  ...
  replace(parent, prop, index5, node) {
    if (parent) {
      if (index5 !== null) {
        parent[prop][index5] = node;
      } else {
        parent[prop] = node;
      }
    }
  }
  remove(parent, prop, index5) {
    if (parent) {
      if (index5 !== null) {
        parent[prop].splice(index5, 1);
      } else {
        delete parent[prop];
      }
    }
  ...
  visit(node, parent, prop, index5) {
    if (node) {
      if (this.enter) {
        ...
        this.should_remove = false;
        this.replacement = null;
        this.enter.call(this.context, node, parent, prop, index5);
        if (this.replacement) {
          node = this.replacement;
          this.replace(parent, prop, index5, node);
        }
        if (this.should_remove) {
          this.remove(parent, prop, index5);
        }
      ...
      if (this.leave) {
        ...
        this.replacement = null;
        this.should_remove = false;
        this.leave.call(this.context, node, parent, prop, index5);
        if (this.replacement) {
          node = this.replacement;
          this.replace(parent, prop, index5, node);
        }
  ...
  walk(tree, {
    enter(node) {
      if (node.type === "Program") {
        ...
        let index5 = -1;
        while (++index5 < comments.length) {
          regex.lastIndex = 0;
          let match = regex.exec(comments[index5].value);
          while (match) {
            annotations[match[1]] = match[2];
            match = regex.exec(comments[index5].value);
          }
        }
    ...
    leave(node) {
      ...
      const children = [];
      let index5 = -1;
      while (++index5 < node.children.length) {
        const child = node.children[index5];
      ...
      if (node.type === "JSXElement") {
        ...
        let index6 = -1;
        while (++index6 < attributes.length) {
          const attribute = attributes[index6];
...
function toMemberExpression(id) {
  ...
  let index5 = -1;
  let result;
  while (++index5 < identifiers.length) {
    const prop = name(identifiers[index5]) ? { type: "Identifier", name: identifiers[index5] } : { type: "Literal", value: identifiers[index5] };
    result = result ? {
      type: "MemberExpression",
      object: result,
      property: prop,
      computed: Boolean(index5 && prop.type === "Literal"),
      optional: false
    } : prop;
  }
  return result;
...
function create(from, node) {
  ...
  let index5 = -1;
  while (++index5 < fields.length) {
    const field = fields[index5];
    if (field in from) {
...
function specifiersToDeclarations(specifiers, init) {
  ...
  while (++index5 < specifiers.length) {
    const specifier = specifiers[index5];
...
function toIdOrMemberExpressionFactory(idType, memberType, isIdentifier) {
  ...
  function toIdOrMemberExpression2(ids) {
    let index5 = -1;
    let object;
    while (++index5 < ids.length) {
      const name2 = ids[index5];
...
function isJsxIdentifierName(name2) {
  let index5 = -1;
  while (++index5 < name2.length) {
    if (!(index5 ? jsxCont : start2)(name2.charCodeAt(index5)))
      return false;
  }
  return index5 > 0;
}
...
// node_modules/@mdx-js/mdx/node_modules/unist-util-stringify-position/index.js
var own11 = {}.hasOwnProperty;
function stringifyPosition4(value) {
  if (!value || typeof value !== "object") {
    return "";
  }
  if (own11.call(value, "position") || own11.call(value, "type")) {
    return position4(value.position);
  }
  if (own11.call(value, "start") || own11.call(value, "end")) {
    return position4(value);
  }
  if (own11.call(value, "line") || own11.call(value, "column")) {
    return point5(value);
  }
  return "";
}
function point5(point7) {
  return index4(point7 && point7.line) + ":" + index4(point7 && point7.column);
}
  ...
  return (tree, file) => {
    ...
    for (child of tree.body) {
      if (child.type === "ExportDefaultDeclaration") {
        if (layout) {
          file.fail("Cannot specify multiple layouts (previous: " + stringifyPosition4(positionFromEstree(layout)) + ")", positionFromEstree(child), "recma-document:duplicate-layout");
        }
        layout = child;
        replacement.push({
          type: "VariableDeclaration",
    ...
    if (outputFormat === "function-body") {
      replacement.push({
        ...
        argument: {
          type: "ObjectExpression",
          properties: [
            ...Array.from({ length: exportAllCount }).map((_, index5) => ({
              type: "SpreadElement",
              argument: { type: "Identifier", name: "_exportAll" + (index5 + 1) }
            })),
...
function toBinaryAddition(expressions) {
  let index5 = -1;
  let left;
  while (++index5 < expressions.length) {
    const right = expressions[index5];
      ...
      enter(_node) {
        ...
        if (currentScope && node.type === "JSXElement") {
          ...
          if (name2.type === "JSXMemberExpression") {
            ...
            if (!own12.call(fnScope.references, fullId)) {
            ...
            if (!inScope(currentScope, id)) {
              if (id !== "MDXLayout" && !own12.call(fnScope.references, id)) {
      ...
      leave(node) {
        ...
        if (node.type === "FunctionDeclaration" || node.type === "FunctionExpression" || node.type === "ArrowFunctionExpression") {
          ...
          for (key in scope.references) {
            if (own12.call(scope.references, key)) {
              const parts = key.split(".");
              let index6 = 0;
              while (++index6 < parts.length) {
                const partial = parts.slice(0, index6).join(".");
                if (!own12.call(scope.references, partial)) {
          ...
          let index5 = -1;
          while (++index5 < references.length) {
            const id = references[index5];
            const info = scope.references[id];
            const place = stringifyPosition4(positionFromEstree(info.node));
            const parameters2 = [
...
function JSXOpeningElement(node, state) {
  ...
  if (node.attributes) {
    while (++index5 < node.attributes.length) {
      state.write(" ");
      this[node.attributes[index5].type](node.attributes[index5], state);
    }
  }
  ...
  for (key in node) {
    ...
    if (value && typeof value === "object" && key !== "comments") {
      if (Array.isArray(value)) {
        index5 = -1;
        while (++index5 < value.length) {
          if (value[index5] && typeof value[index5].type === "string") {
            children.push(value[index5]);
          }
        }
...
function create3(definition2) {
  ...
  for (prop in definition2.properties) {
    if (own13.call(definition2.properties, prop)) {
...
var pointStart2 = point6("start");
var pointEnd2 = point6("end");
function position5(node) {
  return { start: pointStart2(node), end: pointEnd2(node) };
}
function point6(type) {
  return point7;
  function point7(node) {
    const point8 = node && node.position && node.position[type] || {};
    return {
...
function zwitch(key, options) {
  ...
  function one3(value) {
    ...
    if (value && own14.call(value, key)) {
      fn = own14.call(handlers2, value[key]) ? handlers2[value[key]] : one3.unknown;
    }
    if (fn) {
    ...
    if (own15.call(props, prop)) {
      ...
      if (prop === "style") {
        ...
        for (cssProp in styleValue) {
          if (own15.call(styleValue, cssProp)) {
            cssProperties.push({
              type: "Property",
              method: false,
              shorthand: false,
...
function mdxJsxElement(node, context) {
  ...
  const children = all3(node, context);
  const attributes = [];
  while (++index5 < attrs.length) {
    const attr = attrs[index5];
...
function inherit(hast, esnode) {
  ...
  if (left) {
    for (key in left) {
      if (own15.call(left, key) && key !== "estree") {
        if (!right)
          right = {};
        right[key] = left[key];
      }
...
function jsxIdentifierName(name2) {
  let index5 = -1;
  while (++index5 < name2.length) {
    if (!(index5 ? cont3 : start2)(name2.charCodeAt(index5)))
      return false;
  }
  return index5 > 0;
...
function rehypeRemoveRaw() {
  return (tree) => {
    visit2(tree, "raw", (_, index5, parent) => {
      if (parent && typeof index5 === "number") {
...
function remarkMarkAndUnravel() {
  return (tree) => {
    visit2(tree, (node, index5, parent_) => {
      const parent = parent_;
      let offset2 = -1;
      let all4 = true;
      let oneOrMore;
      if (parent && typeof index5 === "number" && node.type === "paragraph") {
        const children = node.children;
        ...
        if (all4 && oneOrMore) {
          ...
          parent.children.splice(index5, 1, ...children);
          return index5;
        }
      }
...
function createProcessor(options = {}) {
  ...
  let index5 = -1;
  while (++index5 < removedOptions.length) {
    const key = removedOptions[index5];
    if (key in options) {
